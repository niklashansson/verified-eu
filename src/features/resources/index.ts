...
import { checkIfSourceExists } from './utils/checkIfSourceExists';
import { combineSourceElements } from './utils/combineSourceElements';
import { createSlotItem } from './utils/createSlotItem';
import { createSourceElement } from './utils/createSourceElement';
import { createSourceItem } from './utils/createSourceItem';
import { getDataFromSourceEl } from './utils/getDataFromSourceElement';
import type { SlotItem, SourceData, SourceElements } from './utils/types';
